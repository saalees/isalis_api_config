...
class WebhookNotificationType(models.Model):
    _name = "isalis_ess.webhook_notification_type"
...
class WebhookNotification(models.Model):
    _name = "isalis_ess.webhook_notification"
    ...
    notification_type = fields.Many2one(
        "isalis_ess.webhook_notification_type", string="Notification Type"
    )
    ...
    def send_notification(
        ...
        if not webhook_url:
            ...
            config = self.env["isalis_ess.webhook_config"].sudo()
